...
contract('ConnectorStorage', function (accounts) {
  ...
  it('should return all connectors of given station', async () => {
    ...
    await storage.addConnector("0x01", "0x01", 1)
    await storage.addConnector("0x02", "0x01", 2)
    await storage.addConnector("0x03", "0x01", 5)
    await storage.addConnector("0x04", "0x06", 5)
